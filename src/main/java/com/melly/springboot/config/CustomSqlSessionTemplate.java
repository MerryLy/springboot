...
public class CustomSqlSessionTemplate extends SqlSessionTemplate {
    ...
    public Map<Object, SqlSessionFactory> getTargetSqlSessionFactory() {
    ...
    public SqlSessionFactory getSqlSessionFactory() {
        ...
        SqlSessionFactory sessionFactory = targetSqlSessionFactory.get(DataSourceContextHolder.getJdbcType());
        if (sessionFactory != null) {
            return sessionFactory;
        } else if (defaultTargetSqlSessionFactory != null) {
            return defaultTargetSqlSessionFactory;
        } else {
            Assert.notNull(targetSqlSessionFactory, "Property 'targetSqlSessionFactory' or 'defaultTargetSqlSessionFactory' are required");
        }
